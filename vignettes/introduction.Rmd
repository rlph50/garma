...
To ensure the results are as comparable as possible we will specify the estimation method as 'CSS' for both.
...
sunspots_garma_mdl <- garma(sunspots, order=c(8,0,0),k=1)
summary(sunspots_garma_mdl)

#prepare 'future' actuals data for plotting
future_df <- data.frame(yr=1925:1935, sunspots=sunspot.year[225:235],.grp='Actuals')

ggplot(sunspots_garma_mdl, h=12) +
