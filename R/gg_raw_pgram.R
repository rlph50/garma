...
#'
#' The standard "R" functions display periodograms on a log scale which can make it more difficult to locate high peaks in the
...
gg_raw_pgram <- function(x, k = 1) {
  ...
  ssx <- internal_garma_pgram(as.numeric(x))
